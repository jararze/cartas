        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-xl overflow-hidden">
                    <div class="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 px-6 py-4 border-b-2 border-slate-200 dark:border-slate-700">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div wire:click="$set('tipoReporte', 'resumen')"
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="p-3 rounded-lg {{ $tipoReporte === 'resumen' ? 'bg-blue-100 dark:bg-blue-900' : 'bg-slate-200 dark:bg-slate-700' }}">
                                    <svg class="w-6 h-6 {{ $tipoReporte === 'resumen' ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Vista general del sistema con estadísticas clave y alertas</p>
                        </div>
                        ...
                        <div wire:click="$set('tipoReporte', 'financiero')"
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="p-3 rounded-lg {{ $tipoReporte === 'financiero' ? 'bg-green-100 dark:bg-green-900' : 'bg-slate-200 dark:bg-slate-700' }}">
                                    <svg class="w-6 h-6 {{ $tipoReporte === 'financiero' ? 'text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Presupuestos, ejecución y saldos detallados por carta</p>
                        </div>
                        ...
                        <div wire:click="$set('tipoReporte', 'avance')"
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="p-3 rounded-lg {{ $tipoReporte === 'avance' ? 'bg-purple-100 dark:bg-purple-900' : 'bg-slate-200 dark:bg-slate-700' }}">
                                    <svg class="w-6 h-6 {{ $tipoReporte === 'avance' ? 'text-purple-600 dark:text-purple-400' : 'text-gray-600 dark:text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Progreso y estados de todas las actividades</p>
                        </div>
                        ...
                        <div wire:click="$set('tipoReporte', 'actividades')"
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="p-3 rounded-lg {{ $tipoReporte === 'actividades' ? 'bg-orange-100 dark:bg-orange-900' : 'bg-slate-200 dark:bg-slate-700' }}">
                                    <svg class="w-6 h-6 {{ $tipoReporte === 'actividades' ? 'text-orange-600 dark:text-orange-400' : 'text-gray-600 dark:text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Listado completo con responsables y fechas</p>
                        </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-xl overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div wire:click="$set('tipoReporte', 'ejecutado_vs_planificado')"
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="p-3 rounded-lg {{ $tipoReporte === 'ejecutado_vs_planificado' ? 'bg-red-100 dark:bg-red-900' : 'bg-slate-200 dark:bg-slate-700' }}">
                                    <svg class="w-6 h-6 {{ $tipoReporte === 'ejecutado_vs_planificado' ? 'text-red-600 dark:text-red-400' : 'text-gray-600 dark:text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Ejecutado vs Planificado</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Comparación de presupuestos planificados vs ejecutados</p>
                            <span class="inline-block mt-2 px-2 py-1 bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 text-xs font-semibold rounded-full">NUEVO</span>
                        </div>
                        ...
                        <div wire:click="$set('tipoReporte', 'plan_trabajo')"
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="p-3 rounded-lg {{ $tipoReporte === 'plan_trabajo' ? 'bg-cyan-100 dark:bg-cyan-900' : 'bg-slate-200 dark:bg-slate-700' }}">
                                    <svg class="w-6 h-6 {{ $tipoReporte === 'plan_trabajo' ? 'text-cyan-600 dark:text-cyan-400' : 'text-gray-600 dark:text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Plan de Trabajo con Gantt</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Productos, actividades y diagrama de Gantt en Excel</p>
                            <span class="inline-block mt-2 px-2 py-1 bg-cyan-100 dark:bg-cyan-900 text-cyan-800 dark:text-cyan-200 text-xs font-semibold rounded-full">NUEVO</span>
                        </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-xl overflow-hidden sticky top-6">
                    ...
                    <form wire:submit="generarReporte" class="p-6 space-y-6">
                        ...
                        {{-- Formato --}}
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Formato de Exportación</label>
                        ...
                        {{-- Filtro por Fechas --}}
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Rango de Fechas</label>
                            <div class="space-y-3">
                        ...
                        @if($this->cartas->count() > 1)
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Filtrar por Carta (opcional)</label>
                        ...
                        @elseif($this->cartas->count() === 1)
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Carta</label>
                        ...
                        {{-- Filtro por Estado --}}
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Estado (opcional)</label>
